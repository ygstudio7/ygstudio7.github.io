...
### 4.1 Valid/Ready Interface Convention
...
### 8.1 Wishbone Write Path Analysis
...
### 8.2 Wishbone Read Path Analysis
...
- **Read Packet Structure**: `min 8-clock IDLE + 8-bit CMD + 16-bit ADDR + 8-bit LEN` = 40 bits
  ...
  ![wb_read_packet](./../../../Downloads/wb_read_packet.png)
